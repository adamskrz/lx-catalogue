...
for gobo in gdata:
    ...
    if not "name" in gobo:
        ...
        if gobo["make"] == "Goboland":
            ...
            goboland_search_url = (
                "https://www.goboland.com/advanced_search_result.php?keywords="
                + gobo_num
                + "&psearch=products&location=United-Kingdom"
            )
            ...
            rosco_search_url = (
                "https://emea.rosco.com/en/products/catalog/gobos?search="
                + str(gobo_num)
            )
            ...
            for result in names:
                ...
                if number == gobo_num:
                    name = (
                        result.find("span", {"class": "text-box"})
                        .text.strip()
                        .split("\n")[0]
                    )
